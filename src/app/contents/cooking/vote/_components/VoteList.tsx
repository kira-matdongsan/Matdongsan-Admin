...
import { getVoteList } from "@/components/Tables/fetch";
...
export function VoteList({ className }: { className?: string }) {
      ...
      <Table>
        <TableHeader>
          <TableRow className="border-none uppercase [&>th]:text-center">
            ...
            <TableHead className="min-w-[130px]">제철요리</TableHead>
