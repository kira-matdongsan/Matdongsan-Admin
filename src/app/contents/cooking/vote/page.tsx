...
import { VoteList } from "./_components/VoteList";
...
export default function Page() {
  return (
    <>
      <Breadcrumb pageName="제철요리 투표 관리" />
      ...
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
        ...
        >
          <div className="grid grid-cols-1 gap-2 sm:grid-cols-[1fr_1fr_1fr_0.5fr] sm:gap-4">
            <div>
        ...
        <div className="col-span-12 grid xl:col-span-8">
          <div className="flex justify-end">
            ...
            <Link href={"/contents/cooking/write"}>
              <Button
                label="등록"
                variant="primary"
                size="small"
